...
export const createDiaryApi = (plantId, data) => axios.post(`${API_BASE}/plants/${plantId}/diaries`, data, authHeader());
export const updateDiaryApi = (plantId, diaryId, data) => axios.put(`${API_BASE}/plants/${plantId}/diaries/${diaryId}`, data, authHeader());
